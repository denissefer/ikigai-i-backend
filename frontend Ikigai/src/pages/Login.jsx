    ...
    return (
        <div className="login flex flex-col items-center min-h-screen px-4 py-8">
            ...
            <header className="mb-8 text-center">
                <h4 className="font-tsukimi  text-2xl mb-32">Ikiga-i</h4>
            ...
            <form className="w-full max-w-sm flex flex-col items-center">
                ...
                <input
                    id="email"
                    type="text"
                    className="font-gotu w-full p-2 mb-4 border  bg-gray-300 rounded-2xl"
                />
                ...
                <input
                    id="password"
                    type="password"
                    className="font-gotu w-full p-2 mb-6 border   bg-gray-300 rounded-2xl"
                />

                <button
                    type="button"
                    className="font-gotu bg-gray-200 text-black  py-2 px-6 rounded-xl hover:bg-gray-600"
