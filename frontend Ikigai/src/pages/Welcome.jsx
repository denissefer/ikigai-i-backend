    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center px-4 m-20">
            ...
            <div className="text-center space-y-12">
                ...
                <h1 className="font-gotu text-4xl text-gray-800 p-5 pb-10">
                    Welcome to your ikigai journey
                </h1>

                <button
                    className="font-gotu px-8 py-2 bg-gray-200 rounded-2xl hover:bg-gray-500 hover:text-white transition duration-300"
